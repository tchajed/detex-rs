...
The initial tests were generated by Claude, then I supplemented with some small test cases extracted from a larger project.

A large bug fix (in handling -s) came from this prompt:

> Read detex.l and lexer.rs and make sure they line up exactly. Add comments to lexer.Rust along the way citing the correspondence. Change lexer.rs as needed.
